	...
	namespace NaturalMotion
	{
		...
		public:
			ApplyBulletImpulseHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "applyBulletImpulse") {
			}
		...
		public:
			ConfigureBalanceHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "configureBalance") {
			}
		...
		public:
			ConfigureSelfAvoidanceHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "configureSelfAvoidance") {
			}
		...
		public:
			ConfigureBulletsHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "configureBullets") {
			}
		...
		public:
			ConfigureBulletsExtraHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "configureBulletsExtra") {
			}
		...
		public:
			ConfigureLimitsHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "configureLimits") {
			}
		...
		public:
			ConfigureSoftLimitHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "configureSoftLimit") {
			}
		...
		public:
			ConfigureShotInjuredArmHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "configureShotInjuredArm") {
			}
		...
		public:
			ConfigureShotInjuredLegHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "configureShotInjuredLeg") {
			}
		...
		public:
			DefineAttachedObjectHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "defineAttachedObject") {
			}
		...
		public:
			ForceToBodyPartHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "forceToBodyPart") {
			}
		...
		public:
			LeanTowardsObjectHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "leanTowardsObject") {
			}
		...
		public:
			HipsLeanTowardsObjectHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "hipsLeanTowardsObject") {
			}
		...
		public:
			ForceLeanTowardsObjectHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "forceLeanTowardsObject") {
			}
		...
		public:
			SetMuscleStiffnessHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "setMuscleStiffness") {
			}
		...
		public:
			SetWeaponModeHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "setWeaponMode") {
			}
		...
		public:
			RegisterWeaponHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "registerWeapon") {
			}
		...
		public:
			ConfigureConstraintsHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "configureConstraints") {
			}
		...
		public:
			SetCharacterStrengthHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "setCharacterStrength") {
			}
		...
		public:
			SetCharacterHealthHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "setCharacterHealth") {
			}
		...
		public:
			SetFallingReactionHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "setFallingReaction") {
			}
		...
		public:
			SetCharacterUnderwaterHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "setCharacterUnderwater") {
			}
		...
		public:
			SetCharacterCollisionsHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "setCharacterCollisions") {
			}
		...
		public:
			SetCharacterDampingHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "setCharacterDamping") {
			}
		...
		public:
			SetFrictionScaleHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "setFrictionScale") {
			}
		...
		public:
			BalancerCollisionsReactionHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "balancerCollisionsReaction") {
			}
		...
		public:
			BraceForImpactHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "braceForImpact") {
			}
		...
		public:
			InjuredOnGroundHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "injuredOnGround") {
			}
		...
		public:
			PointGunExtraHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "pointGunExtra") {
			}
		...
		public:
			RollDownStairsHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "rollDownStairs") {
			}
		...
		public:
			ShotNewBulletHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "shotNewBullet") {
			}
		...
		public:
			ShotShockSpinHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "shotShockSpin") {
			}
		...
		public:
			ShotFallToKneesHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "shotFallToKnees") {
			}
		...
		public:
			ShotFromBehindHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "shotFromBehind") {
			}
		...
		public:
			ShotConfigureArmsHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "shotConfigureArms") {
			}
		...
		public:
			UpperBodyFlinchHelper(GTA::Ped^ Ped)
				:CustomHelper(Ped, "upperBodyFlinch") {
			}
