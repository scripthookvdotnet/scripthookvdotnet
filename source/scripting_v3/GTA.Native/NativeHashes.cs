	...
	namespace Native
	{
		public enum Hash : ulong
		{
			...
			*/
			...
			_IS_PLAYER_WITHIN_TEST_CAPSULE = 0xDD2620B7B9D16FF1, // 0x8CB53C9F
			...
			*/
			...
			_SET_USED_BY_PLAYER = 0x694E00132F2823ED, // 0x40C84A74
			...
			*/
			...
			_IS_ENEMY_IN_RANGE = 0x336B3D200AB007CB, // 0xFB18CB19
			...
			_GET_HAIR_COLOR = 0x4852FC386E2E1BB5, // 
			_GET_LIPSTICK_COLOR = 0x013E5CFC38CD5387, // 
			...
			_TRACK_PED_VISIBILITY = 0x7D7A2E43E74E2EB8, // 0x840D24D3
			...
			GET_QUADBIKE_DISPLAY_VARIATIONS = 0x953563CE563143AF, // 0x4DD03628
			...
			*/
			...
			_SET_VEHICLE_FORKLIFT_HEIGHT = 0x37EBBF3117BD6A25, // 0x943A6CFC
			...
			_IS_THIS_MODEL_A_JETSKI = 0x9537097412CF75FE, // 
			...
			_SET_VEHICLE_ST = 0x1CF38D529D7441D9, // 0xDF594D8D
			_IS_ANY_PASSENGER_RAPPELLING = 0x291E373D483E7EE7, // 0xD656E7E5
			...
			_SET_HELICOPTER_ROLL_PITCH_YAW_MULT_HEALTH = 0x6E0859B530A365CC, // 0x6E67FD35
			...
			_REQUEST_VEHICLE_SCALEFORM_MOVIE = 0xDBA3C090E3D74690, // 
			...
			*/
			...
			_SET_OBJECT_LOD = 0x77F33F2CCF64B3AA, // 0x483C5C88
			...
			*/
			...
			_WAYPOINT_PLAYBACK_START_SHOOTING_AT_PED = 0xE70BA7B90F8390DC, // 
			...
			_IS_TASK_MOVE_SCRIPTED_ACTIVE = 0x921CE12C489C4C41, // 0x902656EB
			_SET_NETWORK_TASK_ACTION = 0xD01015C7316AE176, // 0x885724DE
			_GET_PED_NETWORK_TASK_PHASE = 0x717E4D1F2048376D, // 0x96C0277B
			_SET_NETWORK_TASK_PARAM_FLOAT = 0xD5BB4025AE449A4E, // 0xA79BE783
			_SET_NETWORK_TASK_PARAM_BOOL = 0xB0A6CFD2C69C1088, // 0xF3538041
			...
			*/
			...
			_HAS_ALL_CHUNKS_ON_HDD = 0x14832BF2ABA53FC5, // 
			_CLEANUP_ASYNC_INSTALL = 0xC79AE21974B01FB2, // 
			_SET_SHOW_PED_IN_PAUSE_MENU = 0x4EBB7E87AA0DBED4, // 
			_GET_SHOW_PED_IN_PAUSE_MENU = 0x9689123E3F213AA5, // 
			/*
				AUDIO
			*/
			...
			_RESET_AMBIENT_VOICE = 0x40CF0D12D142A9E8, // 
			...
			_SET_VEHICLE_AS_AMBIENT_EMMITTER = 0xC1805D05E6D4FE10, // 0x7ABB89D2
			...
			*/
			...
			_SET_CAM_PERSPECTIVE = 0x2A2173E46DAECD12, // 0x1DEBCB45
			...
			_F4F2C0D4EE209E20 = 0xF4F2C0D4EE209E20, // 0xD75CDD75
			...
			_GET_REPLAY_FREE_CAM_MAX_RANGE = 0x8BFCEB5EA1B161B6, // 
			/*
				WEAPON
			*/
			...
			*/
			...
			_DRAW_NOTIFICATION_UNLOCK = 0x33EE12743CCD6343, // 0xE05E7052
			_DRAW_NOTIFICATION_UNLOCK_2 = 0xC8F3AAF93D0600BF, // 0x4FA43BA4
			_DRAW_NOTIFICATION_UNLOCK_3 = 0x7AE0589093A2E088, // 0x8C90D22F
			...
			_UPDATE_DISPLAY_CASH = 0x170F541E1CADD1DE, // 
			...
			_SET_DISPLAY_CASH = 0xC2D15BEF167E27BC, // 0xF4F3C796
			_REMOVE_DISPLAY_CASH = 0x95CF81BD06EE1887, // 0x7BFFE82F
			...
			*/
			...
			_ENTITY_DESCRIPTION_TEXT = 0xDEADC0DEDEADC0DE, // 
			DRAW_MARKER = 0x28477EC23D892089, // 0x48D84A02
			CREATE_CHECKPOINT = 0x0134F0835AB6BFCB, // 0xF541B690
			_SET_CHECKPOINT_ICON_HEIGHT = 0x4B5B4DA5D79F1943, // 0x80151CCF
			...
			_TOGGLE_PAUSE_RENDER_PHASES = 0xDFC252D8A3E15AB7, // 0x30ADE541
			...
			_START_NETWORKED_PARTICLE_FX_NON_LOOPED_ON_ENTITY = 0xC95EB1DB6E92113D, // 
			...
			_START_NETWORKED_PARTICLE_FX_LOOPED_ON_ENTITY_BONE = 0xDDE23F30CC5A0F03, // 
			...
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT = 0xC3D0841A0CC546A6, // 0x716777CB
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT = 0xD69736AAE04DB51A, // 0x9A01FFDA
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL = 0xC58424BA936EB458, // 0x0D4AE8CB
			...
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING = 0xBA7148484BD90365, // 0x4DAAD55B
			_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BUTTON_NAME = 0xE83A3E3557A56640, // 0xCCBF0334
			...
			_DRAW_SHOWROOM = 0x98C4FE6EC34154CA, // 0x9A0E3BFE
			...
			*/
			...
			_LEADERBOARDS_DEATHS = 0x428EAF89E24F6C36, // 0xEE292B91
			_LEADERBOARDS2_WRITE_DATA_EX = 0xC980E62E33DF1D5C, // 0x62C19A3D
			_UNLOCK_EXCLUS_CONTENT = 0xDAC073C7901F9E15, // 
			/*
				BRAIN
			*/
			...
			*/
			...
			_HIDE_ROPE = 0xDC57A637A20006ED, // 0x80DB77A7
			...
			*/
			...
			_NETWORK_IS_NP_AVAILABLE = 0x8D11E61A4ABF49CC, // 
			...
			_NETWORK_HAS_RESTRICTED_PROFILE = 0x1353F87E89946207, // 
			...
			_NETWORK_BLOCK_INVITES_2 = 0x4A9FDE3A5A6D0437, // 0x18F03AFD
			...
			GET_PLAYER_STAT_STARS_VISIBILITY = 0x46FB3ED415C7641C, // 0xF9A51B92
			...
			_NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT_2 = 0xD1110739EEADB592, // 
			...
			_NETWORK_GET_PLAYER_PED_FROM_INDEX = 0x638A3A81733086DB, // 0xDB8B5D71
			...
			_NETWORK_PLAYER_IS_CHEATER = 0x565E430DB3B05BEC, // 0xD265B049
			...
			_NETWORK_IS_FRIEND_HANDLE_ONLINE = 0x87EB7A3FFCB314DB, // 
			...
			_NETWORK_RESPAWN_PLAYER = 0xBF22E0F32968E967, // 0x22E03AD0
			...
			_NETWORK_HAVE_TUNABLES_BEEN_DOWNLOADED = 0x0467C11ED88B7D28, // 
			...
			_NETWORK_CACHE_LOCAL_PLAYER_HEAD_BLEND_DATA = 0xBD0BE0BFC927EAC1, // 
			...
			*/
			...
			_NETWORK_EARN_FROM_BEND_JOB = 0x61326EE6DF15B0CA, // 0x5E81F55C
			...
			*/
			...
			_GET_VARIANTS_FOR_COMPONENT_COUNT = 0xC17AD0E5752BECDA, // 0x159751B4
			GET_VARIANT_COMPONENT = 0x6E11F282F11863B6, // 0xE4FF7103
			_GET_NUM_FORCED_COMPONENTS = 0xC6B9DB42C04DD8C3, // 0xCE70F183
			_GET_FORCED_COMPONENT = 0x017568A8182D98A6, // 
			GET_FORCED_COMPONENT = 0x6C93ED8C2F74859B, // 0x382C70BE
			_IS_TAG_RESTRICTED = 0x341DE7ED1D2A1BFD, // 0x8E2C7FD5
			_GET_CHARACTER_OUTFITS_COUNT = 0xF3FBE2D50A6A8C28, // 0x1ECD23E7
			...
			*/
			...
			_RETURN_ZERO2 = 0xEF7D17BC6C85264C, // 0xD87F3A9E
