...
namespace GTA
{
	...
	public sealed class Camera : PoolObject, IEquatable<Camera>, ISpatial
	{
		...
		{
			get { return SHVDN.NativeMemory.GetCameraAddress(Handle); }
		}
	...
	public static class GameplayCamera
	{
		...
		{
			get { return SHVDN.NativeMemory.GetGameplayCameraAddress(); }
		}
		...
		{
			get { return new Vector3(SHVDN.NativeMemory.ReadVector3(MemoryAddress + 0x210)); }
		}
		/// <summary>
		...
		{
			get { return new Vector3(SHVDN.NativeMemory.ReadVector3(MemoryAddress + 0x200)); }
		}
		/// <summary>
		...
		{
			get { return new Vector3(SHVDN.NativeMemory.ReadVector3(MemoryAddress + 0x1F0)); }
		}
		...
		{
			get { return new Matrix(SHVDN.NativeMemory.ReadMatrix(MemoryAddress + 0x1F0)); }
		}
