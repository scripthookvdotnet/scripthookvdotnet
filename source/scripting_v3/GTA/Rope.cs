...
namespace GTA
{
	public sealed class Rope : PoolObject, IEquatable<Rope>
	{
		...
		{
			return !(rope is null) && rope.Exists();
		}

		public bool Equals(Rope rope)
		{
			return !(rope is null) && Handle == rope.Handle;
		}
		public override bool Equals(object rope)
		{
			return !(rope is null) && rope.GetType() == GetType() && Equals((Rope)rope);
		}
