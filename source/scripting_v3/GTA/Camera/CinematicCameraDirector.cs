...
namespace GTA
{
    ...
    public static class CinematicCameraDirector
    {
        ...
        public static bool IsRenderingMountedCam
        {
            get
            {
                GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.v1_0_372_2,
        ...
        public static bool IsCinematicCamInputActive
        {
            get
            {
                ...
                // worth it, though...
                GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.v1_0_1493_0,
