	...
	namespace Native
	{
		public enum class Hash : System::UInt64
		{
			...
			*/
			...
			_IS_THERE_AN_ENTITY_ON_PICKUP_WITHIN_RADIUS = 0xF9C36251F6E48E33,
			...
			*/
			...
			_REQUEST_SCRIPT_HASH = 0xD62A67D26D9653E6,
			_SET_SCRIPT_HASH_AS_NO_LONGER_NEEDED = 0xC5BC038960E9DB27,
			_HAS_SCRIPT_HASH_LOADED = 0x5F0F0C783EB16C04,
			...
			*/
			...
			_GET_IS_NIGHTVISION_INACTIVE = 0x2202A3F42C8E5F79,
			...
			_GET_SEETHROUGH_IS_ACTIVE = 0x44B80ABAB9D80BD3,
			...
			*/
			...
			CLEAR_PLAYER_BAILED_FROM_PLAYERICLE = 0xBAD8F2A42B844821,
			GET_OBJ_ENTITY = 0x82377B65E943F72D,
			...
			*/
			...
			_START_NEW_SCRIPT_HASH = 0xEB1C67C3A5333A92,
			_START_NEW_SCRIPT_HASH_WITH_ARGS = 0xC4BB298BD441BE78,
