...
namespace GTA
{
	...
	{
		unsigned char *const address = reinterpret_cast<unsigned char *>(SHVDN::NativeMemory::GetEntityAddress(Handle).ToPointer());
	...
	{
		System::UInt64 address = SHVDN::NativeMemory::GetEntityAddress(Handle).ToInt64();
