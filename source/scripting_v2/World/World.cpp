...
namespace GTA
{
	...
	{
		array<int> ^entities = SHVDN::NativeMemory::GetPedHandles(nullptr);
	...
	{
		array<int> ^entities = SHVDN::NativeMemory::GetPedHandles(gcnew array<int> { model.Hash });
		array<Ped ^> ^resultHandles = gcnew array<Ped ^>(entities->Length);
	...
	array<Ped ^> ^World::GetNearbyPeds(Ped ^ped, float radius)
	{
		...
		array<int> ^entities = SHVDN::NativeMemory::GetPedHandles(ped->Position.ToArray(), radius, nullptr);
	...
	{
		array<int> ^entities = SHVDN::NativeMemory::GetPedHandles(position.ToArray(), radius, nullptr);
		array<Ped ^> ^resultHandles = gcnew array<Ped ^>(entities->Length);
	...
	{
		array<int> ^entities = SHVDN::NativeMemory::GetPedHandles(position.ToArray(), radius, gcnew array<int> { model.Hash });
		array<Ped ^> ^resultHandles = gcnew array<Ped ^>(entities->Length);
	...
	{
		array<int> ^entities = SHVDN::NativeMemory::GetVehicleHandles(nullptr);
	...
	{
		array<int> ^entities = SHVDN::NativeMemory::GetVehicleHandles(gcnew array<int> { model.Hash });
		array<Vehicle ^> ^resultHandles = gcnew array<Vehicle ^>(entities->Length);
	...
	array<Vehicle ^> ^World::GetNearbyVehicles(Ped ^ped, float radius)
	{
		...
		array<int> ^entities = SHVDN::NativeMemory::GetVehicleHandles(ped->Position.ToArray(), radius, nullptr);
	...
	{
		array<int> ^entities = SHVDN::NativeMemory::GetVehicleHandles(position.ToArray(), radius, nullptr);
		array<Vehicle ^> ^resultHandles = gcnew array<Vehicle ^>(entities->Length);
	...
	{
		array<int> ^entities = SHVDN::NativeMemory::GetVehicleHandles(position.ToArray(), radius, gcnew array<int> { model.Hash });
		array<Vehicle ^> ^resultHandles = gcnew array<Vehicle ^>(entities->Length);
	...
	{
		array<int> ^entities = SHVDN::NativeMemory::GetPropHandles(nullptr);
	...
	{
		array<int> ^entities = SHVDN::NativeMemory::GetPropHandles(gcnew array<int> { model.Hash });
		array<Prop ^> ^resultHandles = gcnew array<Prop ^>(entities->Length);
	...
	{
		array<int> ^entities = SHVDN::NativeMemory::GetPropHandles(position.ToArray(), radius, nullptr);
		array<Prop ^> ^resultHandles = gcnew array<Prop ^>(entities->Length);
	...
	{
		array<int> ^entities = SHVDN::NativeMemory::GetPropHandles(position.ToArray(), radius, gcnew array<int> { model.Hash });
		array<Prop ^> ^resultHandles = gcnew array<Prop ^>(entities->Length);
	...
	array<Entity ^> ^World::GetAllEntities()
	{
		...
		array<int> ^entities = SHVDN::NativeMemory::GetEntityHandles();
	...
	{
		List<Entity ^> ^resultHandles = gcnew List<Entity ^>();
		array<int> ^entities = SHVDN::NativeMemory::GetEntityHandles(position.ToArray(), radius);
