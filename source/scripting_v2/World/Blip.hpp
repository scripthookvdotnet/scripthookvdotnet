...
namespace GTA
{
	...
	public enum class BlipSprite
	{
		...
		Deathmatch = 310,
		ArmWrestling = 311,
		///<summary>The default English text for this value is "Ammu-Nation with Shooting Range".</summary>
		...
		Casino,
		TableGames,
		///<summary>The default English text for this value is "Wheel", but the text can be confusing.</summary>
		LuckyWheel,
		Concierge,
		Chips,
		HorseRacing,
		...
		Limo,
		AlienWeapon,
		///<summary>The default English text for this value is "Enemy".</summary>
		Enemy2
	};
