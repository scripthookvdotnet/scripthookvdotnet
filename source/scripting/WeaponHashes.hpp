...
namespace GTA
{
	namespace Native
	{
		...
		public enum class WeaponComponent : System::UInt32
		{
			...
			RevolverMk2ClipFMJ = 0xC111EB26,
			RevolverMk2ClipHollowPoint = 0x8D107402,
			RevolverMk2ClipIncendiary = 0xE6AD5F79,
			RevolverMk2ClipTracer = 0x902DA26E,
